...
def create_augmentation_layer(augmentation: NamedParams) -> keras.Layer:
    ...
    match augmentation.name:
        case "amplitude_warp":
            return helia.layers.preprocessing.AmplitudeWarp(**augmentation.params)
        ...
        case "random_sine_wave":
            return helia.layers.preprocessing.RandomSineWave(**augmentation.params)
        case "random_cutout":
        ...
        case "random_noise_distortion":
            return helia.layers.preprocessing.RandomNoiseDistortion1D(**augmentation.params)
        case "resizing":
        ...
        case "filter":
            return helia.layers.preprocessing.CascadedBiquadFilter(**augmentation.params)
        case "layer_norm":
...
def create_augmentation_pipeline(augmentations: list[NamedParams]) -> helia.layers.preprocessing.AugmentationPipeline:
