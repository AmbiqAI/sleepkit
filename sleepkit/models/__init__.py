...
To address this, sleepKIT provides a model factory that allows you to easily create and train customized models via [helia-edge](https://ambiqai.github.io/helia-edge/).
...
ModelFactory = helia.utils.ItemFactory[ModelFactoryItem].shared("SKModelFactory")

ModelFactory.register("unet", helia.models.UNetModel.model_from_params)
ModelFactory.register("unext", helia.models.UNetModel.model_from_params)
...
ModelFactory.register("mobileone", helia.models.MobileOneModel.model_from_params)
