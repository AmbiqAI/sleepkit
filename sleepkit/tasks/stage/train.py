...
def train(params: TaskParams):
    ...
    train_subject_ids, val_subject_ids = sklearn.model_selection.train_test_split(
        dataloader.train_subject_ids, test_size=params.val_subjects
    )
    ...
    if params.class_weights == "balanced":
        ...
        class_weights = (class_weights + class_weights.mean()) / 1
    ...
    # Summarize results
    rsts = model.evaluate(val_ds, verbose=params.verbose, return_dict=True)
